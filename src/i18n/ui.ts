...
export const ui = {
	en: {
		...
		"hero.title.1": "Web App",
		"hero.title.2": "Mobile App",
		"hero.title.3": "AI Powered App",
		"hero.title.4": "Data Analytics",
		"hero.subtitle":
			"SKYVE Technology builds and maintains powerful software—from web and mobile apps to enterprise solutions, cloud services, and AI.",
		"hero.scroll": "scroll down to explore more",
		"websites.title": "Web Application",
		"apps.title": "Mobile Application",
		"uiux.title": "AI Powered App",
		"seo.title": "Data Analytics",
		"advertising.title": "Advertising",
		"websites.content": "At Skyve.ae, we specialize in crafting bespoke websites tailored to your brand's needs. Our approach combines aesthetic design with technical proficiency, ensuring your site is visually stunning, fast, and responsive across all devices.",
		...
		"uiux.content": "Skyve Technology integrates AI LLMs with MCP servers, RAG frameworks, and databases to deliver smart, context-aware solutions. Our systems provide real-time, data-driven responses that enhance user experience, automate workflows, and support better decision-making.",
		"seo.content": "Skyve Technology combines advanced data analytics with powerful databases, visualization tools, and AI-driven insights to deliver clear, actionable intelligence. We help businesses turn raw data into informed decisions, streamline operations, and uncover new growth opportunities through smart, real-time analytics solutions.",
	...
	it: {
		...
		"websites.content": "Da Skyve.ae, siamo specializzati nella realizzazione di siti web su misura per le esigenze del tuo marchio. Il nostro approccio combina design estetico con competenza tecnica, garantendo che il tuo sito sia visivamente accattivante, veloce e reattivo su tutti i dispositivi.",
